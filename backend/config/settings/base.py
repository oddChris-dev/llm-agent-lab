"""
Django base settings for LLM Agent Lab.
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LLM Agent Lab API',
    'DESCRIPTION': 'Visual workflow orchestration platform for AI agents',
    'VERSION': '1.0.0',
...
# LLM Agent Lab specific settings
AGENT_LAB = {
    # Provider defaults
    'DEFAULT_LLM_PROVIDER': os.environ.get('DEFAULT_LLM_PROVIDER', 'ollama'),
    'DEFAULT_TTS_PROVIDER': os.environ.get('DEFAULT_TTS_PROVIDER', 'xtts'),
    'DEFAULT_STT_PROVIDER': os.environ.get('DEFAULT_STT_PROVIDER', 'vosk'),

    # Execution settings
    'MAX_CONCURRENT_EXECUTIONS': int(os.environ.get('MAX_CONCURRENT_EXECUTIONS', 5)),
    'NODE_TIMEOUT_SECONDS': int(os.environ.get('NODE_TIMEOUT_SECONDS', 300)),
